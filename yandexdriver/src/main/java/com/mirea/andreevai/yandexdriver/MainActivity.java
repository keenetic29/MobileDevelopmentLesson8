...
import com.mirea.andreevai.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {
    ...
    private final Point ROUTE_END_LOCATION = new Point(55.794245, 37.702039);
    private Point loc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.addTapListener(new MapObjectTapListener() {
            ...
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(),"Кампус МИРЭА на Стромынке :)",
